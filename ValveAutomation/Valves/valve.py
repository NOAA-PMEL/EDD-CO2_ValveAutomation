...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line_4.setGeometry(QtCore.QRect(780, 75, 20, 475))
        self.line_4.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.ReceiveText = QtWidgets.QTextBrowser(self.centralwidget)
        self.ReceiveText.setGeometry(QtCore.QRect(800, 320, 225, 192))
        self.ReceiveText.setObjectName("ReceiveText")
        self.SendText = QtWidgets.QTextEdit(self.centralwidget)
        self.SendText.setGeometry(QtCore.QRect(800, 275, 150, 25))
        self.SendText.setObjectName("SendText")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(800, 60, 75, 13))
        self.label_4.setObjectName("label_4")
        self.label_17 = QtWidgets.QLabel(self.centralwidget)
        self.label_17.setGeometry(QtCore.QRect(800, 260, 75, 13))
        self.label_17.setObjectName("label_17")
        self.label_23 = QtWidgets.QLabel(self.centralwidget)
        self.label_23.setGeometry(QtCore.QRect(800, 305, 100, 13))
        self.label_23.setObjectName("label_23")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(950, 275, 75, 23))
        self.pushButton.setObjectName("pushButton")
        self.SerialWidget = QtWidgets.QWidget(self.centralwidget)
        self.SerialWidget.setGeometry(QtCore.QRect(800, 80, 225, 175))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_17.setText(_translate("MainWindow", "Send String"))
        self.label_23.setText(_translate("MainWindow", "Receive Console"))
